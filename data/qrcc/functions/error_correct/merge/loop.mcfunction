...
$execute unless data storage qrcc:_ data_byte[$(group)][0] run return
$data modify storage qrcc:_ data append from storage qrcc:_ data_byte[$(group)][0]
$data remove storage qrcc:_ data_byte[$(group)][0]
